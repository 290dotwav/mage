...
public final class ModernHorizons3Commander extends ExpansionSet {
    ...
    private ModernHorizons3Commander() {
        ...
        cards.add(new SetCardInfo("Aether Refinery", 54, Rarity.RARE, mage.cards.a.AetherRefinery.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Aether Refinery", 106, Rarity.RARE, mage.cards.a.AetherRefinery.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Aurora Shifter", 45, Rarity.RARE, mage.cards.a.AuroraShifter.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Aurora Shifter", 97, Rarity.RARE, mage.cards.a.AuroraShifter.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Barrowgoyf", 50, Rarity.RARE, mage.cards.b.Barrowgoyf.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Barrowgoyf", 102, Rarity.RARE, mage.cards.b.Barrowgoyf.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Blaster Hulk", 55, Rarity.RARE, mage.cards.b.BlasterHulk.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Blaster Hulk", 107, Rarity.RARE, mage.cards.b.BlasterHulk.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Bloodbraid Challenger", 70, Rarity.RARE, mage.cards.b.BloodbraidChallenger.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Bloodbraid Challenger", 122, Rarity.RARE, mage.cards.b.BloodbraidChallenger.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Broodmate Tyrant", 71, Rarity.RARE, mage.cards.b.BroodmateTyrant.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Broodmate Tyrant", 123, Rarity.RARE, mage.cards.b.BroodmateTyrant.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Cayth, Famed Mechanist", 6, Rarity.MYTHIC, mage.cards.c.CaythFamedMechanist.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Cayth, Famed Mechanist", 10, Rarity.MYTHIC, mage.cards.c.CaythFamedMechanist.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Cayth, Famed Mechanist", 18, Rarity.MYTHIC, mage.cards.c.CaythFamedMechanist.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Cayth, Famed Mechanist", 26, Rarity.MYTHIC, mage.cards.c.CaythFamedMechanist.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Conversion Apparatus", 76, Rarity.RARE, mage.cards.c.ConversionApparatus.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Conversion Apparatus", 128, Rarity.RARE, mage.cards.c.ConversionApparatus.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Copy Land", 47, Rarity.RARE, mage.cards.c.CopyLand.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Copy Land", 99, Rarity.RARE, mage.cards.c.CopyLand.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Coram, the Undertaker", 7, Rarity.MYTHIC, mage.cards.c.CoramTheUndertaker.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Coram, the Undertaker", 11, Rarity.MYTHIC, mage.cards.c.CoramTheUndertaker.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Coram, the Undertaker", 19, Rarity.MYTHIC, mage.cards.c.CoramTheUndertaker.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Coram, the Undertaker", 27, Rarity.MYTHIC, mage.cards.c.CoramTheUndertaker.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Disa the Restless", 1, Rarity.MYTHIC, mage.cards.d.DisaTheRestless.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Disa the Restless", 12, Rarity.MYTHIC, mage.cards.d.DisaTheRestless.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Disa the Restless", 20, Rarity.MYTHIC, mage.cards.d.DisaTheRestless.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Disa the Restless", 28, Rarity.MYTHIC, mage.cards.d.DisaTheRestless.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Exterminator Magmarch", 72, Rarity.RARE, mage.cards.e.ExterminatorMagmarch.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Exterminator Magmarch", 124, Rarity.RARE, mage.cards.e.ExterminatorMagmarch.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Filigree Racer", 56, Rarity.RARE, mage.cards.f.FiligreeRacer.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Filigree Racer", 108, Rarity.RARE, mage.cards.f.FiligreeRacer.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Final Act", 52, Rarity.RARE, mage.cards.f.FinalAct.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Final Act", 104, Rarity.RARE, mage.cards.f.FinalAct.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Gluttonous Hellkite", 73, Rarity.RARE, mage.cards.g.GluttonousHellkite.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Gluttonous Hellkite", 125, Rarity.RARE, mage.cards.g.GluttonousHellkite.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Horizon of Progress", 78, Rarity.RARE, mage.cards.h.HorizonOfProgress.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Horizon of Progress", 130, Rarity.RARE, mage.cards.h.HorizonOfProgress.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Infested Thrinax", 74, Rarity.RARE, mage.cards.i.InfestedThrinax.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Infested Thrinax", 126, Rarity.RARE, mage.cards.i.InfestedThrinax.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Jyoti, Moag Ancient", 8, Rarity.MYTHIC, mage.cards.j.JyotiMoagAncient.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Jyoti, Moag Ancient", 13, Rarity.MYTHIC, mage.cards.j.JyotiMoagAncient.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Jyoti, Moag Ancient", 21, Rarity.MYTHIC, mage.cards.j.JyotiMoagAncient.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Jyoti, Moag Ancient", 29, Rarity.MYTHIC, mage.cards.j.JyotiMoagAncient.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Lazotep Quarry", 79, Rarity.RARE, mage.cards.l.LazotepQuarry.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Lazotep Quarry", 131, Rarity.RARE, mage.cards.l.LazotepQuarry.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Localized Destruction", 41, Rarity.RARE, mage.cards.l.LocalizedDestruction.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Localized Destruction", 93, Rarity.RARE, mage.cards.l.LocalizedDestruction.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("March from Velis Vel", 48, Rarity.RARE, mage.cards.m.MarchFromVelisVel.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("March from Velis Vel", 100, Rarity.RARE, mage.cards.m.MarchFromVelisVel.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Omo, Queen of Vesuva", 2, Rarity.MYTHIC, mage.cards.o.OmoQueenOfVesuva.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Omo, Queen of Vesuva", 14, Rarity.MYTHIC, mage.cards.o.OmoQueenOfVesuva.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Omo, Queen of Vesuva", 22, Rarity.MYTHIC, mage.cards.o.OmoQueenOfVesuva.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Omo, Queen of Vesuva", 30, Rarity.MYTHIC, mage.cards.o.OmoQueenOfVesuva.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Opal Palace", 361, Rarity.COMMON, mage.cards.o.OpalPalace.class));
        cards.add(new SetCardInfo("Overclocked Electromancer", 58, Rarity.RARE, mage.cards.o.OverclockedElectromancer.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Overclocked Electromancer", 110, Rarity.RARE, mage.cards.o.OverclockedElectromancer.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Planar Nexus", 80, Rarity.RARE, mage.cards.p.PlanarNexus.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Planar Nexus", 132, Rarity.RARE, mage.cards.p.PlanarNexus.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Poison Dart Frog", 238, Rarity.COMMON, mage.cards.p.PoisonDartFrog.class));
        cards.add(new SetCardInfo("Polygoyf", 65, Rarity.RARE, mage.cards.p.Polygoyf.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Polygoyf", 117, Rarity.RARE, mage.cards.p.Polygoyf.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Pyrogoyf", 59, Rarity.RARE, mage.cards.p.Pyrogoyf.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Pyrogoyf", 111, Rarity.RARE, mage.cards.p.Pyrogoyf.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Rampant Frogantua", 66, Rarity.RARE, mage.cards.r.RampantFrogantua.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Rampant Frogantua", 118, Rarity.RARE, mage.cards.r.RampantFrogantua.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Razorfield Ripper", 42, Rarity.RARE, mage.cards.r.RazorfieldRipper.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Razorfield Ripper", 94, Rarity.RARE, mage.cards.r.RazorfieldRipper.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Sage of the Maze", 67, Rarity.RARE, mage.cards.s.SageOfTheMaze.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Sage of the Maze", 119, Rarity.RARE, mage.cards.s.SageOfTheMaze.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Sakura-Tribe Elder", 243, Rarity.COMMON, mage.cards.s.SakuraTribeElder.class));
        cards.add(new SetCardInfo("Salvation Colossus", 43, Rarity.RARE, mage.cards.s.SalvationColossus.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Salvation Colossus", 95, Rarity.RARE, mage.cards.s.SalvationColossus.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Satya, Aetherflux Genius", 3, Rarity.MYTHIC, mage.cards.s.SatyaAetherfluxGenius.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Satya, Aetherflux Genius", 15, Rarity.MYTHIC, mage.cards.s.SatyaAetherfluxGenius.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Satya, Aetherflux Genius", 23, Rarity.MYTHIC, mage.cards.s.SatyaAetherfluxGenius.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Satya, Aetherflux Genius", 31, Rarity.MYTHIC, mage.cards.s.SatyaAetherfluxGenius.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Sawhorn Nemesis", 60, Rarity.RARE, mage.cards.s.SawhornNemesis.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Sawhorn Nemesis", 112, Rarity.RARE, mage.cards.s.SawhornNemesis.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Siege-Gang Lieutenant", 61, Rarity.RARE, mage.cards.s.SiegeGangLieutenant.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Siege-Gang Lieutenant", 113, Rarity.RARE, mage.cards.s.SiegeGangLieutenant.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Sifter of Skulls", 203, Rarity.RARE, mage.cards.s.SifterOfSkulls.class));
        cards.add(new SetCardInfo("Silverquill Lecturer", 44, Rarity.RARE, mage.cards.s.SilverquillLecturer.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Silverquill Lecturer", 96, Rarity.RARE, mage.cards.s.SilverquillLecturer.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Sphinx of the Revelation", 75, Rarity.RARE, mage.cards.s.SphinxOfTheRevelation.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Sphinx of the Revelation", 127, Rarity.RARE, mage.cards.s.SphinxOfTheRevelation.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Stitcher's Supplier", 204, Rarity.UNCOMMON, mage.cards.s.StitchersSupplier.class));
        cards.add(new SetCardInfo("Stone Idol Generator", 77, Rarity.RARE, mage.cards.s.StoneIdolGenerator.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Stone Idol Generator", 129, Rarity.RARE, mage.cards.s.StoneIdolGenerator.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Sunken Palace", 81, Rarity.RARE, mage.cards.s.SunkenPalace.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Sunken Palace", 133, Rarity.RARE, mage.cards.s.SunkenPalace.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Talon Gates of Madara", 82, Rarity.RARE, mage.cards.t.TalonGatesOfMadara.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Talon Gates of Madara", 134, Rarity.RARE, mage.cards.t.TalonGatesOfMadara.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Tarmogoyf Nest", 68, Rarity.RARE, mage.cards.t.TarmogoyfNest.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Tarmogoyf Nest", 120, Rarity.RARE, mage.cards.t.TarmogoyfNest.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Tempt with Mayhem", 62, Rarity.RARE, mage.cards.t.TemptWithMayhem.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Tempt with Mayhem", 114, Rarity.RARE, mage.cards.t.TemptWithMayhem.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Trenchpost", 83, Rarity.RARE, mage.cards.t.Trenchpost.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Trenchpost", 135, Rarity.RARE, mage.cards.t.Trenchpost.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Ulalek, Fused Atrocity", 4, Rarity.MYTHIC, mage.cards.u.UlalekFusedAtrocity.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Ulalek, Fused Atrocity", 16, Rarity.MYTHIC, mage.cards.u.UlalekFusedAtrocity.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Ulalek, Fused Atrocity", 24, Rarity.MYTHIC, mage.cards.u.UlalekFusedAtrocity.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Wonderscape Sage", 49, Rarity.RARE, mage.cards.w.WonderscapeSage.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Wonderscape Sage", 101, Rarity.RARE, mage.cards.w.WonderscapeSage.class, NON_FULL_USE_VARIOUS));
