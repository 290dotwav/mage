...
public final class MarvelSuperHeroes extends ExpansionSet {
    ...
    private MarvelSuperHeroes() {
        ...
        cards.add(new SetCardInfo("Abomination, Terrifying Titan", 198, Rarity.UNCOMMON, mage.cards.a.AbominationTerrifyingTitan.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Abomination, Terrifying Titan", 333, Rarity.UNCOMMON, mage.cards.a.AbominationTerrifyingTitan.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Absorbing Man", 199, Rarity.RARE, mage.cards.a.AbsorbingMan.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Absorbing Man", 416, Rarity.RARE, mage.cards.a.AbsorbingMan.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Alien Invasion", 200, Rarity.RARE, mage.cards.a.AlienInvasion.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Alien Invasion", 417, Rarity.RARE, mage.cards.a.AlienInvasion.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Arnim Zola, Bio-Fanatic", 86, Rarity.UNCOMMON, mage.cards.a.ArnimZolaBioFanatic.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Avengers: Under Siege", 205, Rarity.RARE, mage.cards.a.AvengersUnderSiege.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Avengers: Under Siege", 306, Rarity.RARE, mage.cards.a.AvengersUnderSiege.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Baron Helmut Zemo", 405, Rarity.RARE, mage.cards.b.BaronHelmutZemo.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Baron Helmut Zemo", 87, Rarity.RARE, mage.cards.b.BaronHelmutZemo.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Beast, Erudite Aerialist", 206, Rarity.UNCOMMON, mage.cards.b.BeastEruditeAerialist.class));
        ...
        cards.add(new SetCardInfo("Bruce Banner", 331, Rarity.MYTHIC, mage.cards.b.BruceBanner.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Bruce Banner", 359, Rarity.MYTHIC, mage.cards.b.BruceBanner.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Bullseye, Death Dealer", 209, Rarity.UNCOMMON, mage.cards.b.BullseyeDeathDealer.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Bullseye, Death Dealer", 325, Rarity.UNCOMMON, mage.cards.b.BullseyeDeathDealer.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Call Damage Control", 162, Rarity.COMMON, mage.cards.c.CallDamageControl.class));
        ...
        cards.add(new SetCardInfo("Captain America's Shield", 311, Rarity.RARE, mage.cards.c.CaptainAmericasShield.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Captain America, Living Legend", 210, Rarity.UNCOMMON, mage.cards.c.CaptainAmericaLivingLegend.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Captain America, Living Legend", 449, Rarity.UNCOMMON, mage.cards.c.CaptainAmericaLivingLegend.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Captain America, Super-Soldier", 316, Rarity.MYTHIC, mage.cards.c.CaptainAmericaSuperSoldier.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Captain America, Super-Soldier", 352, Rarity.MYTHIC, mage.cards.c.CaptainAmericaSuperSoldier.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Cloak and Dagger, Entwined", 211, Rarity.RARE, mage.cards.c.CloakAndDaggerEntwined.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Cloak and Dagger, Entwined", 419, Rarity.RARE, mage.cards.c.CloakAndDaggerEntwined.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Daredevil, Man Without Fear", 213, Rarity.RARE, mage.cards.d.DaredevilManWithoutFear.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Daredevil, Man Without Fear", 324, Rarity.RARE, mage.cards.d.DaredevilManWithoutFear.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Daredevil, Man Without Fear", 372, Rarity.RARE, mage.cards.d.DaredevilManWithoutFear.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Daredevil, Man Without Fear", 398, Rarity.RARE, mage.cards.d.DaredevilManWithoutFear.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Daredevil, Man Without Fear", 432, Rarity.RARE, mage.cards.d.DaredevilManWithoutFear.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Earth's Mightiest Heroes", 165, Rarity.MYTHIC, mage.cards.e.EarthsMightiestHeroes.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Earth's Mightiest Heroes", 349, Rarity.MYTHIC, mage.cards.e.EarthsMightiestHeroes.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Earth's Mightiest Heroes", 413, Rarity.MYTHIC, mage.cards.e.EarthsMightiestHeroes.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Evil's Thrall", 128, Rarity.UNCOMMON, mage.cards.e.EvilsThrall.class));
        ...
        cards.add(new SetCardInfo("HULK SMASH!", 135, Rarity.COMMON, mage.cards.h.HULKSMASH.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Hawkeye, Master Marksman", 130, Rarity.RARE, mage.cards.h.HawkeyeMasterMarksman.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Hawkeye, Master Marksman", 367, Rarity.RARE, mage.cards.h.HawkeyeMasterMarksman.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Helicarrier Strike", 15, Rarity.COMMON, mage.cards.h.HelicarrierStrike.class));
        ...
        cards.add(new SetCardInfo("Jennifer Walters", 18, Rarity.MYTHIC, mage.cards.j.JenniferWalters.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Jennifer Walters", 328, Rarity.MYTHIC, mage.cards.j.JenniferWalters.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Nick Fury, Agent of S.H.I.E.L.D.", 25, Rarity.RARE, mage.cards.n.NickFuryAgentOfSHIELD.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("The Kingpin of Crime", 327, Rarity.RARE, mage.cards.t.TheKingpinOfCrime.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("The Kingpin of Crime", 374, Rarity.RARE, mage.cards.t.TheKingpinOfCrime.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("The Masters of Evil", 105, Rarity.UNCOMMON, mage.cards.t.TheMastersOfEvil.class));
        cards.add(new SetCardInfo("The Mighty Thor, Jane Foster", 222, Rarity.RARE, mage.cards.t.TheMightyThorJaneFoster.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("The Mighty Thor, Jane Foster", 420, Rarity.RARE, mage.cards.t.TheMightyThorJaneFoster.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("The Vision", 255, Rarity.RARE, mage.cards.t.TheVision.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("The Vision", 379, Rarity.RARE, mage.cards.t.TheVision.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Winter Soldier, Icy Assassin", 239, Rarity.RARE, mage.cards.w.WinterSoldierIcyAssassin.class, NON_FULL_USE_VARIOUS));
