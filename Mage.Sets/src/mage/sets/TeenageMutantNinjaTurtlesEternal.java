...
public final class TeenageMutantNinjaTurtlesEternal extends ExpansionSet {
    ...
    private TeenageMutantNinjaTurtlesEternal() {
        super("Teenage Mutant Ninja Turtles Eternal", "TMC", ExpansionSet.buildDate(2026, 3, 6), SetType.SUPPLEMENTAL);
        ...
        cards.add(new SetCardInfo("April O'Neil, Live on the Scene", 84, Rarity.MYTHIC, mage.cards.a.AprilONeilLiveOnTheScene.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("April O'Neil, Live on the Scene", 9, Rarity.MYTHIC, mage.cards.a.AprilONeilLiveOnTheScene.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Continue?", 7, Rarity.RARE, mage.cards.c.Continue.class));
        ...
        cards.add(new SetCardInfo("Fast Forward", 24, Rarity.RARE, mage.cards.f.FastForward.class));
        ...
        cards.add(new SetCardInfo("Foot Chopper", 17, Rarity.RARE, mage.cards.f.FootChopper.class));
        cards.add(new SetCardInfo("Game Over", 18, Rarity.RARE, mage.cards.g.GameOver.class));
        ...
        cards.add(new SetCardInfo("Irma, Part-Time Mutant", 12, Rarity.RARE, mage.cards.i.IrmaPartTimeMutant.class));
        ...
        cards.add(new SetCardInfo("Mikey & Mona, Mutant Sitters", 125, Rarity.RARE, mage.cards.m.MikeyAndMonaMutantSitters.class));
        cards.add(new SetCardInfo("Mole Module", 40, Rarity.RARE, mage.cards.m.MoleModule.class));
        cards.add(new SetCardInfo("Mona Lisa, Ever Adaptable", 126, Rarity.RARE, mage.cards.m.MonaLisaEverAdaptable.class));
        cards.add(new SetCardInfo("Monster Mashup", 117, Rarity.COMMON, mage.cards.m.MonsterMashup.class));
        ...
        cards.add(new SetCardInfo("Ray Fillet, Wave Warrior", 14, Rarity.RARE, mage.cards.r.RayFilletWaveWarrior.class));
        ...
        cards.add(new SetCardInfo("Shellshock", 25, Rarity.RARE, mage.cards.s.Shellshock.class));
        ...
        cards.add(new SetCardInfo("Vigor", 53, Rarity.RARE, mage.cards.v.Vigor.class));
