...
public final class CommanderLegendsBattleForBaldursGate extends ExpansionSet {
    ...
    private CommanderLegendsBattleForBaldursGate() {
        ...
        // https://mtg.fandom.com/wiki/Commander_Legends:_Battle_for_Baldur%27s_Gate
        this.enableCollectorBooster(Integer.MAX_VALUE); // simplified to use all cards as collector booster
        ...
        cards.add(new SetCardInfo("Abdel Adrian, Gorion's Ward", 471, Rarity.UNCOMMON, mage.cards.a.AbdelAdrianGorionsWard.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Aboleth Spawn", 612, Rarity.RARE, mage.cards.a.AbolethSpawn.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Aboleth Spawn", 662, Rarity.RARE, mage.cards.a.AbolethSpawn.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Acolyte of Bahamut", 212, Rarity.UNCOMMON, mage.cards.a.AcolyteOfBahamut.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Acolyte of Bahamut", 513, Rarity.UNCOMMON, mage.cards.a.AcolyteOfBahamut.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Aether Gale", 712, Rarity.RARE, mage.cards.a.AetherGale.class));
        cards.add(new SetCardInfo("Agent of the Iron Throne", 107, Rarity.UNCOMMON, mage.cards.a.AgentOfTheIronThrone.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Agent of the Iron Throne", 492, Rarity.UNCOMMON, mage.cards.a.AgentOfTheIronThrone.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Altar of Bhaal", 109, Rarity.RARE, mage.cards.a.AltarOfBhaal.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Altar of Bhaal", 569, Rarity.RARE, mage.cards.a.AltarOfBhaal.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Amber Gristle O'Maul", 502, Rarity.UNCOMMON, mage.cards.a.AmberGristleOMaul.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Ancient Brass Dragon", 111, Rarity.MYTHIC, mage.cards.a.AncientBrassDragon.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Ancient Brass Dragon", 367, Rarity.MYTHIC, mage.cards.a.AncientBrassDragon.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Ancient Brass Dragon", 389, Rarity.MYTHIC, mage.cards.a.AncientBrassDragon.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Ancient Bronze Dragon", 214, Rarity.MYTHIC, mage.cards.a.AncientBronzeDragon.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Ancient Bronze Dragon", 369, Rarity.MYTHIC, mage.cards.a.AncientBronzeDragon.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Ancient Bronze Dragon", 406, Rarity.MYTHIC, mage.cards.a.AncientBronzeDragon.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Ancient Copper Dragon", 161, Rarity.MYTHIC, mage.cards.a.AncientCopperDragon.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Ancient Copper Dragon", 368, Rarity.MYTHIC, mage.cards.a.AncientCopperDragon.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Ancient Copper Dragon", 396, Rarity.MYTHIC, mage.cards.a.AncientCopperDragon.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Ancient Gold Dragon", 3, Rarity.MYTHIC, mage.cards.a.AncientGoldDragon.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Ancient Gold Dragon", 365, Rarity.MYTHIC, mage.cards.a.AncientGoldDragon.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Ancient Gold Dragon", 376, Rarity.MYTHIC, mage.cards.a.AncientGoldDragon.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Ancient Silver Dragon", 366, Rarity.MYTHIC, mage.cards.a.AncientSilverDragon.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Ancient Silver Dragon", 382, Rarity.MYTHIC, mage.cards.a.AncientSilverDragon.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Ancient Silver Dragon", 56, Rarity.MYTHIC, mage.cards.a.AncientSilverDragon.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Archivist of Oghma", 4, Rarity.RARE, mage.cards.a.ArchivistOfOghma.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Archivist of Oghma", 553, Rarity.RARE, mage.cards.a.ArchivistOfOghma.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Ascend from Avernus", 5, Rarity.RARE, mage.cards.a.AscendFromAvernus.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Ascend from Avernus", 554, Rarity.RARE, mage.cards.a.AscendFromAvernus.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Ash Barrens", 880, Rarity.UNCOMMON, mage.cards.a.AshBarrens.class));
        cards.add(new SetCardInfo("Astarion's Thirst", 114, Rarity.RARE, mage.cards.a.AstarionsThirst.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Astarion's Thirst", 570, Rarity.RARE, mage.cards.a.AstarionsThirst.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Astarion, the Decadent", 265, Rarity.RARE, mage.cards.a.AstarionTheDecadent.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Astarion, the Decadent", 413, Rarity.RARE, mage.cards.a.AstarionTheDecadent.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Astarion, the Decadent", 524, Rarity.RARE, mage.cards.a.AstarionTheDecadent.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Astral Confrontation", 6, Rarity.COMMON, mage.cards.a.AstralConfrontation.class));
        cards.add(new SetCardInfo("Astral Dragon", 613, Rarity.RARE, mage.cards.a.AstralDragon.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Astral Dragon", 664, Rarity.RARE, mage.cards.a.AstralDragon.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Baba Lysaga, Night Witch", 266, Rarity.RARE, mage.cards.b.BabaLysagaNightWitch.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Baba Lysaga, Night Witch", 414, Rarity.RARE, mage.cards.b.BabaLysagaNightWitch.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Baba Lysaga, Night Witch", 525, Rarity.RARE, mage.cards.b.BabaLysagaNightWitch.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Baeloth Barrityl, Entertainer", 627, Rarity.MYTHIC, mage.cards.b.BaelothBarritylEntertainer.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Baeloth Barrityl, Entertainer", 655, Rarity.MYTHIC, mage.cards.b.BaelothBarritylEntertainer.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Bag of Holding", 299, Rarity.UNCOMMON, mage.cards.b.BagOfHolding.class));
        cards.add(new SetCardInfo("Baldur's Gate", 345, Rarity.RARE, mage.cards.b.BaldursGate.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Baldur's Gate", 600, Rarity.RARE, mage.cards.b.BaldursGate.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Balor", 162, Rarity.MYTHIC, mage.cards.b.Balor.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Balor", 578, Rarity.MYTHIC, mage.cards.b.Balor.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Bane, Lord of Darkness", 267, Rarity.RARE, mage.cards.b.BaneLordOfDarkness.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Bane, Lord of Darkness", 415, Rarity.RARE, mage.cards.b.BaneLordOfDarkness.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Bane, Lord of Darkness", 526, Rarity.RARE, mage.cards.b.BaneLordOfDarkness.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Banishment", 8, Rarity.UNCOMMON, mage.cards.b.Banishment.class));
        cards.add(new SetCardInfo("Barroom Brawl", 217, Rarity.RARE, mage.cards.b.BarroomBrawl.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Barroom Brawl", 587, Rarity.RARE, mage.cards.b.BarroomBrawl.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Basilisk Collar", 300, Rarity.RARE, mage.cards.b.BasiliskCollar.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Basilisk Collar", 595, Rarity.RARE, mage.cards.b.BasiliskCollar.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Basilisk Gate", 346, Rarity.COMMON, mage.cards.b.BasiliskGate.class));
        cards.add(new SetCardInfo("Battle Angels of Tyr", 370, Rarity.MYTHIC, mage.cards.b.BattleAngelsOfTyr.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Battle Angels of Tyr", 9, Rarity.MYTHIC, mage.cards.b.BattleAngelsOfTyr.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Bhaal, Lord of Murder", 268, Rarity.RARE, mage.cards.b.BhaalLordOfMurder.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Bhaal, Lord of Murder", 416, Rarity.RARE, mage.cards.b.BhaalLordOfMurder.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Bhaal, Lord of Murder", 527, Rarity.RARE, mage.cards.b.BhaalLordOfMurder.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Black Dragon Gate", 347, Rarity.COMMON, mage.cards.b.BlackDragonGate.class));
        cards.add(new SetCardInfo("Black Market Connections", 620, Rarity.RARE, mage.cards.b.BlackMarketConnections.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Black Market Connections", 669, Rarity.RARE, mage.cards.b.BlackMarketConnections.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Black Market", 739, Rarity.RARE, mage.cards.b.BlackMarket.class));
        cards.add(new SetCardInfo("Blade of Selves", 301, Rarity.RARE, mage.cards.b.BladeOfSelves.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Blade of Selves", 596, Rarity.RARE, mage.cards.b.BladeOfSelves.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Blood Money", 116, Rarity.MYTHIC, mage.cards.b.BloodMoney.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Blood Money", 571, Rarity.MYTHIC, mage.cards.b.BloodMoney.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Bothersome Quasit", 628, Rarity.RARE, mage.cards.b.BothersomeQuasit.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Bothersome Quasit", 674, Rarity.RARE, mage.cards.b.BothersomeQuasit.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Bountiful Promenade", 348, Rarity.RARE, mage.cards.b.BountifulPromenade.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Bountiful Promenade", 601, Rarity.RARE, mage.cards.b.BountifulPromenade.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Brainstealer Dragon", 621, Rarity.RARE, mage.cards.b.BrainstealerDragon.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Brainstealer Dragon", 670, Rarity.RARE, mage.cards.b.BrainstealerDragon.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Bramble Sovereign", 218, Rarity.MYTHIC, mage.cards.b.BrambleSovereign.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Bramble Sovereign", 372, Rarity.MYTHIC, mage.cards.b.BrambleSovereign.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Burakos, Party Leader", 622, Rarity.MYTHIC, mage.cards.b.BurakosPartyLeader.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Burakos, Party Leader", 653, Rarity.MYTHIC, mage.cards.b.BurakosPartyLeader.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Cadira, Caller of the Small", 528, Rarity.UNCOMMON, mage.cards.c.CadiraCallerOfTheSmall.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Calculating Lich", 742, Rarity.MYTHIC, mage.cards.c.CalculatingLich.class));
        cards.add(new SetCardInfo("Call to the Void", 118, Rarity.RARE, mage.cards.c.CallToTheVoid.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Call to the Void", 572, Rarity.RARE, mage.cards.c.CallToTheVoid.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Candlekeep Sage", 482, Rarity.COMMON, mage.cards.c.CandlekeepSage.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Candlekeep Sage", 60, Rarity.COMMON, mage.cards.c.CandlekeepSage.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Captain N'ghathrod", 640, Rarity.MYTHIC, mage.cards.c.CaptainNghathrod.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Captain N'ghathrod", 646, Rarity.MYTHIC, mage.cards.c.CaptainNghathrod.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Captain N'ghathrod", 931, Rarity.MYTHIC, mage.cards.c.CaptainNghathrod.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Caves of Chaos Adventurer", 167, Rarity.RARE, mage.cards.c.CavesOfChaosAdventurer.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Caves of Chaos Adventurer", 579, Rarity.RARE, mage.cards.c.CavesOfChaosAdventurer.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Clan Crafter", 614, Rarity.MYTHIC, mage.cards.c.ClanCrafter.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Clan Crafter", 651, Rarity.MYTHIC, mage.cards.c.ClanCrafter.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Cloakwood Hermit", 221, Rarity.UNCOMMON, mage.cards.c.CloakwoodHermit.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Cloakwood Hermit", 514, Rarity.UNCOMMON, mage.cards.c.CloakwoodHermit.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Criminal Past", 122, Rarity.UNCOMMON, mage.cards.c.CriminalPast.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Criminal Past", 494, Rarity.UNCOMMON, mage.cards.c.CriminalPast.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Cultist of the Absolute", 123, Rarity.RARE, mage.cards.c.CultistOfTheAbsolute.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Cultist of the Absolute", 495, Rarity.RARE, mage.cards.c.CultistOfTheAbsolute.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Death Kiss", 629, Rarity.RARE, mage.cards.d.DeathKiss.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Death Kiss", 675, Rarity.RARE, mage.cards.d.DeathKiss.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Delayed Blast Fireball", 630, Rarity.RARE, mage.cards.d.DelayedBlastFireball.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Delayed Blast Fireball", 676, Rarity.RARE, mage.cards.d.DelayedBlastFireball.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Demon Bolt", 787, Rarity.COMMON, mage.cards.d.DemonBolt.class));
        cards.add(new SetCardInfo("Descent into Avernus", 169, Rarity.RARE, mage.cards.d.DescentIntoAvernus.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Descent into Avernus", 580, Rarity.RARE, mage.cards.d.DescentIntoAvernus.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Displacer Kitten", 560, Rarity.RARE, mage.cards.d.DisplacerKitten.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Displacer Kitten", 63, Rarity.RARE, mage.cards.d.DisplacerKitten.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Dragon Cultist", 170, Rarity.UNCOMMON, mage.cards.d.DragonCultist.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Dragon Cultist", 503, Rarity.UNCOMMON, mage.cards.d.DragonCultist.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Duke Ulder Ravengard", 272, Rarity.RARE, mage.cards.d.DukeUlderRavengard.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Duke Ulder Ravengard", 420, Rarity.RARE, mage.cards.d.DukeUlderRavengard.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Duke Ulder Ravengard", 531, Rarity.RARE, mage.cards.d.DukeUlderRavengard.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Dynaheir, Invoker Adept", 421, Rarity.RARE, mage.cards.d.DynaheirInvokerAdept.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Dynaheir, Invoker Adept", 532, Rarity.RARE, mage.cards.d.DynaheirInvokerAdept.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Earth Tremor", 171, Rarity.COMMON, mage.cards.e.EarthTremor.class));
        cards.add(new SetCardInfo("Earthquake Dragon", 228, Rarity.RARE, mage.cards.e.EarthquakeDragon.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Earthquake Dragon", 588, Rarity.RARE, mage.cards.e.EarthquakeDragon.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Eight-and-a-Half-Tails", 692, Rarity.RARE, mage.cards.e.EightAndAHalfTails.class));
        cards.add(new SetCardInfo("Elder Brain", 125, Rarity.RARE, mage.cards.e.ElderBrain.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Elder Brain", 573, Rarity.RARE, mage.cards.e.ElderBrain.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Elder Brain", 936, Rarity.RARE, mage.cards.e.ElderBrain.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Eldritch Pact", 126, Rarity.RARE, mage.cards.e.EldritchPact.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Eldritch Pact", 574, Rarity.RARE, mage.cards.e.EldritchPact.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Ellyn Harbreeze, Busybody", 472, Rarity.UNCOMMON, mage.cards.e.EllynHarbreezeBusybody.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Elminster", 274, Rarity.MYTHIC, mage.cards.e.Elminster.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Elminster", 362, Rarity.MYTHIC, mage.cards.e.Elminster.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Elminster's Simulacrum", 561, Rarity.MYTHIC, mage.cards.e.ElminstersSimulacrum.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Elminster's Simulacrum", 68, Rarity.MYTHIC, mage.cards.e.ElminstersSimulacrum.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Elturel Survivors", 172, Rarity.RARE, mage.cards.e.ElturelSurvivors.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Elturel Survivors", 581, Rarity.RARE, mage.cards.e.ElturelSurvivors.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Erinis, Gloom Stalker", 515, Rarity.UNCOMMON, mage.cards.e.ErinisGloomStalker.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Faldorn, Dread Wolf Herald", 641, Rarity.MYTHIC, mage.cards.f.FaldornDreadWolfHerald.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Faldorn, Dread Wolf Herald", 647, Rarity.MYTHIC, mage.cards.f.FaldornDreadWolfHerald.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Faldorn, Dread Wolf Herald", 932, Rarity.MYTHIC, mage.cards.f.FaldornDreadWolfHerald.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Fang Dragon", 173, Rarity.COMMON, mage.cards.f.FangDragon.class));
        cards.add(new SetCardInfo("Far Traveler", 17, Rarity.UNCOMMON, mage.cards.f.FarTraveler.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Far Traveler", 473, Rarity.UNCOMMON, mage.cards.f.FarTraveler.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Feywild Visitor", 484, Rarity.UNCOMMON, mage.cards.f.FeywildVisitor.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Feywild Visitor", 70, Rarity.UNCOMMON, mage.cards.f.FeywildVisitor.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Firbolg Flutist", 174, Rarity.RARE, mage.cards.f.FirbolgFlutist.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Firbolg Flutist", 582, Rarity.RARE, mage.cards.f.FirbolgFlutist.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Fireball", 175, Rarity.UNCOMMON, mage.cards.f.Fireball.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Fireball", 397, Rarity.UNCOMMON, mage.cards.f.Fireball.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Firja's Retribution", 846, Rarity.RARE, mage.cards.f.FirjasRetribution.class));
        cards.add(new SetCardInfo("Firkraag, Cunning Instigator", 642, Rarity.MYTHIC, mage.cards.f.FirkraagCunningInstigator.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Firkraag, Cunning Instigator", 648, Rarity.MYTHIC, mage.cards.f.FirkraagCunningInstigator.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Firkraag, Cunning Instigator", 933, Rarity.MYTHIC, mage.cards.f.FirkraagCunningInstigator.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Flaming Fist Officer", 19, Rarity.COMMON, mage.cards.f.FlamingFistOfficer.class));
        cards.add(new SetCardInfo("Flaming Fist", 18, Rarity.COMMON, mage.cards.f.FlamingFist.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Flaming Fist", 474, Rarity.COMMON, mage.cards.f.FlamingFist.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Folk Hero", 608, Rarity.MYTHIC, mage.cards.f.FolkHero.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Folk Hero", 650, Rarity.MYTHIC, mage.cards.f.FolkHero.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Font of Magic", 562, Rarity.MYTHIC, mage.cards.f.FontOfMagic.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Font of Magic", 71, Rarity.MYTHIC, mage.cards.f.FontOfMagic.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Forest", 467, Rarity.LAND, mage.cards.basiclands.Forest.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Forest", 468, Rarity.LAND, mage.cards.basiclands.Forest.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Forest", 469, Rarity.LAND, mage.cards.basiclands.Forest.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Forest", 470, Rarity.LAND, mage.cards.basiclands.Forest.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Fraying Line", 314, Rarity.RARE, mage.cards.f.FrayingLine.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Fraying Line", 597, Rarity.RARE, mage.cards.f.FrayingLine.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("From the Catacombs", 623, Rarity.RARE, mage.cards.f.FromTheCatacombs.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("From the Catacombs", 671, Rarity.RARE, mage.cards.f.FromTheCatacombs.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Frontline Medic", 693, Rarity.RARE, mage.cards.f.FrontlineMedic.class));
        cards.add(new SetCardInfo("Gale's Redirection", 563, Rarity.RARE, mage.cards.g.GalesRedirection.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Gale's Redirection", 73, Rarity.RARE, mage.cards.g.GalesRedirection.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Gale, Waterdeep Prodigy", 383, Rarity.RARE, mage.cards.g.GaleWaterdeepProdigy.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Gale, Waterdeep Prodigy", 485, Rarity.RARE, mage.cards.g.GaleWaterdeepProdigy.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Gale, Waterdeep Prodigy", 72, Rarity.RARE, mage.cards.g.GaleWaterdeepProdigy.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Ganax, Astral Hunter", 504, Rarity.UNCOMMON, mage.cards.g.GanaxAstralHunter.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Gluntch, the Bestower", 275, Rarity.RARE, mage.cards.g.GluntchTheBestower.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Gluntch, the Bestower", 422, Rarity.RARE, mage.cards.g.GluntchTheBestower.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Gluntch, the Bestower", 533, Rarity.RARE, mage.cards.g.GluntchTheBestower.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Gorion, Wise Mentor", 276, Rarity.RARE, mage.cards.g.GorionWiseMentor.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Gorion, Wise Mentor", 423, Rarity.RARE, mage.cards.g.GorionWiseMentor.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Gorion, Wise Mentor", 534, Rarity.RARE, mage.cards.g.GorionWiseMentor.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Green Slime", 636, Rarity.RARE, mage.cards.g.GreenSlime.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Green Slime", 680, Rarity.RARE, mage.cards.g.GreenSlime.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Grell Philosopher", 616, Rarity.RARE, mage.cards.g.GrellPhilosopher.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Grell Philosopher", 666, Rarity.RARE, mage.cards.g.GrellPhilosopher.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Guild Artisan", 179, Rarity.UNCOMMON, mage.cards.g.GuildArtisan.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Guild Artisan", 505, Rarity.UNCOMMON, mage.cards.g.GuildArtisan.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Gut, True Soul Zealot", 506, Rarity.UNCOMMON, mage.cards.g.GutTrueSoulZealot.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Halsin, Emerald Archdruid", 516, Rarity.UNCOMMON, mage.cards.h.HalsinEmeraldArchdruid.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Hammers of Moradin", 25, Rarity.UNCOMMON, mage.cards.h.HammersOfMoradin.class));
        cards.add(new SetCardInfo("Hardy Outlander", 235, Rarity.UNCOMMON, mage.cards.h.HardyOutlander.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Hardy Outlander", 517, Rarity.UNCOMMON, mage.cards.h.HardyOutlander.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Harper Recruiter", 609, Rarity.RARE, mage.cards.h.HarperRecruiter.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Harper Recruiter", 659, Rarity.RARE, mage.cards.h.HarperRecruiter.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Haunted One", 624, Rarity.MYTHIC, mage.cards.h.HauntedOne.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Haunted One", 654, Rarity.MYTHIC, mage.cards.h.HauntedOne.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Horn of Valhalla", 26, Rarity.RARE, mage.cards.h.HornOfValhalla.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Horn of Valhalla", 555, Rarity.RARE, mage.cards.h.HornOfValhalla.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Imoen, Mystic Trickster", 486, Rarity.UNCOMMON, mage.cards.i.ImoenMysticTrickster.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Inspiring Leader", 28, Rarity.UNCOMMON, mage.cards.i.InspiringLeader.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Inspiring Leader", 475, Rarity.UNCOMMON, mage.cards.i.InspiringLeader.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Island", 456, Rarity.LAND, mage.cards.basiclands.Island.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Island", 457, Rarity.LAND, mage.cards.basiclands.Island.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Island", 458, Rarity.LAND, mage.cards.basiclands.Island.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Jaheira's Respite", 238, Rarity.RARE, mage.cards.j.JaheirasRespite.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Jaheira's Respite", 589, Rarity.RARE, mage.cards.j.JaheirasRespite.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Jaheira, Friend of the Forest", 237, Rarity.RARE, mage.cards.j.JaheiraFriendOfTheForest.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Jaheira, Friend of the Forest", 409, Rarity.RARE, mage.cards.j.JaheiraFriendOfTheForest.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Jaheira, Friend of the Forest", 518, Rarity.RARE, mage.cards.j.JaheiraFriendOfTheForest.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Jan Jansen, Chaos Crafter", 277, Rarity.RARE, mage.cards.j.JanJansenChaosCrafter.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Jan Jansen, Chaos Crafter", 424, Rarity.RARE, mage.cards.j.JanJansenChaosCrafter.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Jan Jansen, Chaos Crafter", 535, Rarity.RARE, mage.cards.j.JanJansenChaosCrafter.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Journey to the Lost City", 637, Rarity.RARE, mage.cards.j.JourneyToTheLostCity.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Journey to the Lost City", 681, Rarity.RARE, mage.cards.j.JourneyToTheLostCity.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Kagha, Shadow Archdruid", 537, Rarity.UNCOMMON, mage.cards.k.KaghaShadowArchdruid.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Karlach, Fury of Avernus", 186, Rarity.MYTHIC, mage.cards.k.KarlachFuryOfAvernus.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Karlach, Fury of Avernus", 400, Rarity.MYTHIC, mage.cards.k.KarlachFuryOfAvernus.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Karlach, Fury of Avernus", 507, Rarity.MYTHIC, mage.cards.k.KarlachFuryOfAvernus.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Kindred Discovery", 565, Rarity.RARE, mage.cards.k.KindredDiscovery.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Kindred Discovery", 81, Rarity.RARE, mage.cards.k.KindredDiscovery.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Korlessa, Scale Singer", 538, Rarity.UNCOMMON, mage.cards.k.KorlessaScaleSinger.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Lae'zel, Vlaakith's Champion", 29, Rarity.RARE, mage.cards.l.LaezelVlaakithsChampion.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Lae'zel, Vlaakith's Champion", 378, Rarity.RARE, mage.cards.l.LaezelVlaakithsChampion.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Lae'zel, Vlaakith's Champion", 476, Rarity.RARE, mage.cards.l.LaezelVlaakithsChampion.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Legion Loyalty", 31, Rarity.MYTHIC, mage.cards.l.LegionLoyalty.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Legion Loyalty", 371, Rarity.MYTHIC, mage.cards.l.LegionLoyalty.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Livaan, Cultist of Tiamat", 508, Rarity.UNCOMMON, mage.cards.l.LivaanCultistOfTiamat.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Loot Dispute", 631, Rarity.RARE, mage.cards.l.LootDispute.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Loot Dispute", 677, Rarity.RARE, mage.cards.l.LootDispute.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Lozhan, Dragons' Legacy", 539, Rarity.UNCOMMON, mage.cards.l.LozhanDragonsLegacy.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Lulu, Loyal Hollyphant", 477, Rarity.UNCOMMON, mage.cards.l.LuluLoyalHollyphant.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Lurking Green Dragon", 239, Rarity.COMMON, mage.cards.l.LurkingGreenDragon.class));
        cards.add(new SetCardInfo("Luxury Suite", 355, Rarity.RARE, mage.cards.l.LuxurySuite.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Luxury Suite", 602, Rarity.RARE, mage.cards.l.LuxurySuite.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Mahadi, Emporium Master", 540, Rarity.UNCOMMON, mage.cards.m.MahadiEmporiumMaster.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Majestic Genesis", 240, Rarity.MYTHIC, mage.cards.m.MajesticGenesis.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Majestic Genesis", 590, Rarity.MYTHIC, mage.cards.m.MajesticGenesis.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Master Chef", 241, Rarity.COMMON, mage.cards.m.MasterChef.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Master Chef", 519, Rarity.COMMON, mage.cards.m.MasterChef.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Mighty Servant of Leuk-o", 324, Rarity.RARE, mage.cards.m.MightyServantOfLeukO.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Mighty Servant of Leuk-o", 598, Rarity.RARE, mage.cards.m.MightyServantOfLeukO.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Miirym, Sentinel Wyrm", 284, Rarity.RARE, mage.cards.m.MiirymSentinelWyrm.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Miirym, Sentinel Wyrm", 431, Rarity.RARE, mage.cards.m.MiirymSentinelWyrm.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Miirym, Sentinel Wyrm", 542, Rarity.RARE, mage.cards.m.MiirymSentinelWyrm.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Mirror of Life Trapping", 326, Rarity.RARE, mage.cards.m.MirrorOfLifeTrapping.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Mirror of Life Trapping", 599, Rarity.RARE, mage.cards.m.MirrorOfLifeTrapping.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Mizzium Mortars", 803, Rarity.RARE, mage.cards.m.MizziumMortars.class));
        cards.add(new SetCardInfo("Mocking Doppelganger", 617, Rarity.RARE, mage.cards.m.MockingDoppelganger.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Mocking Doppelganger", 667, Rarity.RARE, mage.cards.m.MockingDoppelganger.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Monster Manual", 242, Rarity.RARE, mage.cards.m.MonsterManual.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Monster Manual", 591, Rarity.RARE, mage.cards.m.MonsterManual.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Moonshae Pixie", 84, Rarity.UNCOMMON, mage.cards.m.MoonshaePixie.class));
        cards.add(new SetCardInfo("Morphic Pool", 357, Rarity.RARE, mage.cards.m.MorphicPool.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Morphic Pool", 603, Rarity.RARE, mage.cards.m.MorphicPool.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Mountain", 464, Rarity.LAND, mage.cards.basiclands.Mountain.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Mountain", 465, Rarity.LAND, mage.cards.basiclands.Mountain.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Mountain", 466, Rarity.LAND, mage.cards.basiclands.Mountain.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Multiclass Baldric", 644, Rarity.RARE, mage.cards.m.MulticlassBaldric.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Multiclass Baldric", 684, Rarity.RARE, mage.cards.m.MulticlassBaldric.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Myrkul, Lord of Bones", 287, Rarity.RARE, mage.cards.m.MyrkulLordOfBones.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Myrkul, Lord of Bones", 433, Rarity.RARE, mage.cards.m.MyrkulLordOfBones.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Myrkul, Lord of Bones", 544, Rarity.RARE, mage.cards.m.MyrkulLordOfBones.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Mystery Key", 85, Rarity.UNCOMMON, mage.cards.m.MysteryKey.class));
        cards.add(new SetCardInfo("Nalfeshnee", 632, Rarity.RARE, mage.cards.n.Nalfeshnee.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Nalfeshnee", 678, Rarity.RARE, mage.cards.n.Nalfeshnee.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Nalia de'Arnise", 643, Rarity.MYTHIC, mage.cards.n.NaliaDeArnise.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Nalia de'Arnise", 649, Rarity.MYTHIC, mage.cards.n.NaliaDeArnise.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Nalia de'Arnise", 934, Rarity.MYTHIC, mage.cards.n.NaliaDeArnise.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Nautiloid Ship", 328, Rarity.MYTHIC, mage.cards.n.NautiloidShip.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Nautiloid Ship", 373, Rarity.MYTHIC, mage.cards.n.NautiloidShip.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Navigation Orb", 329, Rarity.COMMON, mage.cards.n.NavigationOrb.class));
        cards.add(new SetCardInfo("Neera, Wild Mage", 288, Rarity.RARE, mage.cards.n.NeeraWildMage.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Neera, Wild Mage", 434, Rarity.RARE, mage.cards.n.NeeraWildMage.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Neera, Wild Mage", 545, Rarity.RARE, mage.cards.n.NeeraWildMage.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Nemesis Phoenix", 189, Rarity.UNCOMMON, mage.cards.n.NemesisPhoenix.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Nemesis Phoenix", 403, Rarity.UNCOMMON, mage.cards.n.NemesisPhoenix.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Nine-Fingers Keene", 289, Rarity.RARE, mage.cards.n.NineFingersKeene.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Nine-Fingers Keene", 435, Rarity.RARE, mage.cards.n.NineFingersKeene.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Nine-Fingers Keene", 546, Rarity.RARE, mage.cards.n.NineFingersKeene.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Niv-Mizzet, Parun", 851, Rarity.RARE, mage.cards.n.NivMizzetParun.class));
        cards.add(new SetCardInfo("Noble Heritage", 35, Rarity.RARE, mage.cards.n.NobleHeritage.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Noble Heritage", 478, Rarity.RARE, mage.cards.n.NobleHeritage.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Oji, the Exquisite Blade", 547, Rarity.UNCOMMON, mage.cards.o.OjiTheExquisiteBlade.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Owlbear Cub", 246, Rarity.RARE, mage.cards.o.OwlbearCub.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Owlbear Cub", 592, Rarity.RARE, mage.cards.o.OwlbearCub.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Passionate Archaeologist", 633, Rarity.MYTHIC, mage.cards.p.PassionateArchaeologist.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Passionate Archaeologist", 656, Rarity.MYTHIC, mage.cards.p.PassionateArchaeologist.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Plains", 452, Rarity.LAND, mage.cards.basiclands.Plains.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Plains", 453, Rarity.LAND, mage.cards.basiclands.Plains.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Plains", 454, Rarity.LAND, mage.cards.basiclands.Plains.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Popular Entertainer", 192, Rarity.RARE, mage.cards.p.PopularEntertainer.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Popular Entertainer", 509, Rarity.RARE, mage.cards.p.PopularEntertainer.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Psionic Ritual", 618, Rarity.RARE, mage.cards.p.PsionicRitual.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Psionic Ritual", 668, Rarity.RARE, mage.cards.p.PsionicRitual.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Raggadragga, Goreguts Boss", 291, Rarity.RARE, mage.cards.r.RaggadraggaGoregutsBoss.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Raggadragga, Goreguts Boss", 437, Rarity.RARE, mage.cards.r.RaggadraggaGoregutsBoss.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Raggadragga, Goreguts Boss", 548, Rarity.RARE, mage.cards.r.RaggadraggaGoregutsBoss.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Raging Ravine", 910, Rarity.RARE, mage.cards.r.RagingRavine.class));
        cards.add(new SetCardInfo("Raised by Giants", 250, Rarity.RARE, mage.cards.r.RaisedByGiants.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Raised by Giants", 520, Rarity.RARE, mage.cards.r.RaisedByGiants.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Raphael, Fiendish Savior", 292, Rarity.RARE, mage.cards.r.RaphaelFiendishSavior.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Raphael, Fiendish Savior", 438, Rarity.RARE, mage.cards.r.RaphaelFiendishSavior.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Raphael, Fiendish Savior", 549, Rarity.RARE, mage.cards.r.RaphaelFiendishSavior.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Rasaad yn Bashir", 479, Rarity.UNCOMMON, mage.cards.r.RasaadYnBashir.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Ravenloft Adventurer", 142, Rarity.RARE, mage.cards.r.RavenloftAdventurer.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Ravenloft Adventurer", 577, Rarity.RARE, mage.cards.r.RavenloftAdventurer.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Reflecting Pool", 358, Rarity.RARE, mage.cards.r.ReflectingPool.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Reflecting Pool", 604, Rarity.RARE, mage.cards.r.ReflectingPool.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Renari, Merchant of Marvels", 487, Rarity.UNCOMMON, mage.cards.r.RenariMerchantOfMarvels.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Rilsa Rael, Kingpin", 550, Rarity.UNCOMMON, mage.cards.r.RilsaRaelKingpin.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("River of Tears", 912, Rarity.RARE, mage.cards.r.RiverOfTears.class));
        cards.add(new SetCardInfo("Robe of the Archmagi", 566, Rarity.RARE, mage.cards.r.RobeOfTheArchmagi.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Robe of the Archmagi", 91, Rarity.RARE, mage.cards.r.RobeOfTheArchmagi.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Safana, Calimport Cutthroat", 496, Rarity.UNCOMMON, mage.cards.s.SafanaCalimportCutthroat.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Sarevok's Tome", 645, Rarity.RARE, mage.cards.s.SarevoksTome.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Sarevok's Tome", 685, Rarity.RARE, mage.cards.s.SarevoksTome.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Sarevok, Deathbringer", 497, Rarity.UNCOMMON, mage.cards.s.SarevokDeathbringer.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Scaled Nurturer", 252, Rarity.COMMON, mage.cards.s.ScaledNurturer.class));
        cards.add(new SetCardInfo("Scion of Halaster", 145, Rarity.COMMON, mage.cards.s.ScionOfHalaster.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Scion of Halaster", 498, Rarity.COMMON, mage.cards.s.ScionOfHalaster.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Scouting Hawk", 41, Rarity.COMMON, mage.cards.s.ScoutingHawk.class));
        cards.add(new SetCardInfo("Sculpted Sunburst", 42, Rarity.RARE, mage.cards.s.SculptedSunburst.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Sculpted Sunburst", 557, Rarity.RARE, mage.cards.s.SculptedSunburst.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Sea of Clouds", 360, Rarity.RARE, mage.cards.s.SeaOfClouds.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Sea of Clouds", 605, Rarity.RARE, mage.cards.s.SeaOfClouds.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Search for Tomorrow", 834, Rarity.COMMON, mage.cards.s.SearchForTomorrow.class));
        cards.add(new SetCardInfo("Seasoned Dungeoneer", 610, Rarity.RARE, mage.cards.s.SeasonedDungeoneer.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Seasoned Dungeoneer", 660, Rarity.RARE, mage.cards.s.SeasonedDungeoneer.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Shadowheart, Dark Justiciar", 146, Rarity.RARE, mage.cards.s.ShadowheartDarkJusticiar.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Shadowheart, Dark Justiciar", 392, Rarity.RARE, mage.cards.s.ShadowheartDarkJusticiar.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Shadowheart, Dark Justiciar", 499, Rarity.RARE, mage.cards.s.ShadowheartDarkJusticiar.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Shambling Vent", 914, Rarity.RARE, mage.cards.s.ShamblingVent.class));
        cards.add(new SetCardInfo("Shameless Charlatan", 488, Rarity.RARE, mage.cards.s.ShamelessCharlatan.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Shameless Charlatan", 96, Rarity.RARE, mage.cards.s.ShamelessCharlatan.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Sivriss, Nightmare Speaker", 500, Rarity.UNCOMMON, mage.cards.s.SivrissNightmareSpeaker.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Skanos Dragonheart", 521, Rarity.UNCOMMON, mage.cards.s.SkanosDragonheart.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Solemn Doomguide", 625, Rarity.RARE, mage.cards.s.SolemnDoomguide.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Solemn Doomguide", 672, Rarity.RARE, mage.cards.s.SolemnDoomguide.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Spectacular Showdown", 634, Rarity.RARE, mage.cards.s.SpectacularShowdown.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Spectacular Showdown", 679, Rarity.RARE, mage.cards.s.SpectacularShowdown.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Spire Garden", 361, Rarity.RARE, mage.cards.s.SpireGarden.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Spire Garden", 606, Rarity.RARE, mage.cards.s.SpireGarden.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Stick Together", 611, Rarity.RARE, mage.cards.s.StickTogether.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Stick Together", 661, Rarity.RARE, mage.cards.s.StickTogether.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Stonespeaker Crystal", 338, Rarity.UNCOMMON, mage.cards.s.StonespeakerCrystal.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Stonespeaker Crystal", 450, Rarity.UNCOMMON, mage.cards.s.StonespeakerCrystal.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Storm King's Thunder", 196, Rarity.MYTHIC, mage.cards.s.StormKingsThunder.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Storm King's Thunder", 583, Rarity.MYTHIC, mage.cards.s.StormKingsThunder.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Street Urchin", 197, Rarity.UNCOMMON, mage.cards.s.StreetUrchin.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Street Urchin", 510, Rarity.UNCOMMON, mage.cards.s.StreetUrchin.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Swamp", 460, Rarity.LAND, mage.cards.basiclands.Swamp.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Swamp", 461, Rarity.LAND, mage.cards.basiclands.Swamp.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Swamp", 462, Rarity.LAND, mage.cards.basiclands.Swamp.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Sword Coast Sailor", 489, Rarity.UNCOMMON, mage.cards.s.SwordCoastSailor.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Sword Coast Sailor", 98, Rarity.UNCOMMON, mage.cards.s.SwordCoastSailor.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Tasha, the Witch Queen", 294, Rarity.MYTHIC, mage.cards.t.TashaTheWitchQueen.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Tasha, the Witch Queen", 364, Rarity.MYTHIC, mage.cards.t.TashaTheWitchQueen.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Taunting Kobold", 199, Rarity.UNCOMMON, mage.cards.t.TauntingKobold.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Taunting Kobold", 404, Rarity.UNCOMMON, mage.cards.t.TauntingKobold.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Tavern Brawler", 200, Rarity.COMMON, mage.cards.t.TavernBrawler.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Tavern Brawler", 511, Rarity.COMMON, mage.cards.t.TavernBrawler.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("The Council of Four", 271, Rarity.RARE, mage.cards.t.TheCouncilOfFour.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("The Council of Four", 419, Rarity.RARE, mage.cards.t.TheCouncilOfFour.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("The Council of Four", 530, Rarity.RARE, mage.cards.t.TheCouncilOfFour.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Thrakkus the Butcher", 551, Rarity.UNCOMMON, mage.cards.t.ThrakkusTheButcher.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Tlincalli Hunter", 638, Rarity.RARE, mage.cards.t.TlincalliHunter.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Tlincalli Hunter", 682, Rarity.RARE, mage.cards.t.TlincalliHunter.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Tomb of Horrors Adventurer", 100, Rarity.RARE, mage.cards.t.TombOfHorrorsAdventurer.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Tomb of Horrors Adventurer", 567, Rarity.RARE, mage.cards.t.TombOfHorrorsAdventurer.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Traverse the Outlands", 258, Rarity.RARE, mage.cards.t.TraverseTheOutlands.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Traverse the Outlands", 593, Rarity.RARE, mage.cards.t.TraverseTheOutlands.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Uchuulon", 626, Rarity.RARE, mage.cards.u.Uchuulon.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Uchuulon", 673, Rarity.RARE, mage.cards.u.Uchuulon.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Undermountain Adventurer", 260, Rarity.RARE, mage.cards.u.UndermountainAdventurer.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Undermountain Adventurer", 594, Rarity.RARE, mage.cards.u.UndermountainAdventurer.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Venture Forth", 639, Rarity.RARE, mage.cards.v.VentureForth.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Venture Forth", 683, Rarity.RARE, mage.cards.v.VentureForth.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Veteran Soldier", 48, Rarity.UNCOMMON, mage.cards.v.VeteranSoldier.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Veteran Soldier", 480, Rarity.UNCOMMON, mage.cards.v.VeteranSoldier.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Vexing Puzzlebox", 343, Rarity.MYTHIC, mage.cards.v.VexingPuzzlebox.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Vexing Puzzlebox", 374, Rarity.MYTHIC, mage.cards.v.VexingPuzzlebox.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Vhal, Candlekeep Researcher", 490, Rarity.UNCOMMON, mage.cards.v.VhalCandlekeepResearcher.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Viconia, Drow Apostate", 501, Rarity.UNCOMMON, mage.cards.v.ViconiaDrowApostate.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Volo, Itinerant Scholar", 103, Rarity.MYTHIC, mage.cards.v.VoloItinerantScholar.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Volo, Itinerant Scholar", 388, Rarity.MYTHIC, mage.cards.v.VoloItinerantScholar.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Volo, Itinerant Scholar", 491, Rarity.MYTHIC, mage.cards.v.VoloItinerantScholar.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Vrock", 157, Rarity.UNCOMMON, mage.cards.v.Vrock.class));
        cards.add(new SetCardInfo("Wand of Wonder", 204, Rarity.RARE, mage.cards.w.WandOfWonder.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Wand of Wonder", 584, Rarity.RARE, mage.cards.w.WandOfWonder.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Wand of Wonder", 935, Rarity.RARE, mage.cards.w.WandOfWonder.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("White Plume Adventurer", 49, Rarity.RARE, mage.cards.w.WhitePlumeAdventurer.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("White Plume Adventurer", 558, Rarity.RARE, mage.cards.w.WhitePlumeAdventurer.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Wilson, Refined Grizzly", 522, Rarity.UNCOMMON, mage.cards.w.WilsonRefinedGrizzly.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Windbrisk Heights", 930, Rarity.RARE, mage.cards.w.WindbriskHeights.class));
        //cards.add(new SetCardInfo("Windshaper Planetar", 50, Rarity.RARE, mage.cards.w.WindshaperPlanetar.class, NON_FULL_USE_VARIOUS));
        //cards.add(new SetCardInfo("Windshaper Planetar", 559, Rarity.RARE, mage.cards.w.WindshaperPlanetar.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Winter Eladrin", 104, Rarity.COMMON, mage.cards.w.WinterEladrin.class));
        cards.add(new SetCardInfo("Wizards of Thay", 105, Rarity.RARE, mage.cards.w.WizardsOfThay.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Wizards of Thay", 568, Rarity.RARE, mage.cards.w.WizardsOfThay.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Woe Strider", 774, Rarity.RARE, mage.cards.w.WoeStrider.class));
        cards.add(new SetCardInfo("Wrathful Red Dragon", 207, Rarity.RARE, mage.cards.w.WrathfulRedDragon.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Wrathful Red Dragon", 585, Rarity.RARE, mage.cards.w.WrathfulRedDragon.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Wyll's Reversal", 209, Rarity.RARE, mage.cards.w.WyllsReversal.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Wyll's Reversal", 586, Rarity.RARE, mage.cards.w.WyllsReversal.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Wyll, Blade of Frontiers", 208, Rarity.RARE, mage.cards.w.WyllBladeOfFrontiers.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Wyll, Blade of Frontiers", 405, Rarity.RARE, mage.cards.w.WyllBladeOfFrontiers.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Wyll, Blade of Frontiers", 512, Rarity.RARE, mage.cards.w.WyllBladeOfFrontiers.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Zellix, Sanity Flayer", 619, Rarity.MYTHIC, mage.cards.z.ZellixSanityFlayer.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Zellix, Sanity Flayer", 652, Rarity.MYTHIC, mage.cards.z.ZellixSanityFlayer.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Zevlor, Elturel Exile", 296, Rarity.RARE, mage.cards.z.ZevlorElturelExile.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Zevlor, Elturel Exile", 441, Rarity.RARE, mage.cards.z.ZevlorElturelExile.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Zevlor, Elturel Exile", 552, Rarity.RARE, mage.cards.z.ZevlorElturelExile.class, NON_FULL_USE_VARIOUS));
