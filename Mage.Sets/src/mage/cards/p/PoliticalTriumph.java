...
public final class PoliticalTriumph extends CardImpl {
    ...
    public PoliticalTriumph(UUID ownerId, CardSetInfo setInfo) {
        ...
        Ability ability = new EntersBattlefieldControlledTriggeredAbility(
                new ScryEffect(1, false), StaticFilters.FILTER_PERMANENT_A_CREATURE
        );
        ...
        Ability planAbility = new PlanCounterThresholdTriggeredAbility(
                4, new SacrificeSourceEffect().setText("sacrifice it")
        );
        planAbility.addEffect(new DrawCardSourceControllerEffect(1).concatBy(","));
        planAbility.addEffect(new AddCountersAllEffect(
